...
typedef struct sm5703_fled_platform_data {
	...
	unsigned int fled_factory_current;
	struct pinctrl *fled_pinctrl;
	struct pinctrl_state *gpio_state_active;
	struct pinctrl_state *gpio_state_suspend;
} sm5703_fled_platform_data_t;

enum sm5703_fled_mode {
	SM5703_FLED_MODE_OFF = 0,
	SM5703_FLED_MODE_PREFLASH,
	SM5703_FLED_MODE_FLASH,
	SM5703_FLED_MODE_EXT_GPIO_ENABLE,
	SM5703_FLED_MODE_EXT_GPIO_DISABLE,
	SM5703_FLED_MODE_MOVIE,
};
